...
השוואה שיטתית בין הסיווג שלנו לסיווג של טל אלוביץ (K19–K25):

- **31,308 הצעות סווגו על ידי שנינו**
- **הסכמה כוללת: 52%**
- **14,877 הצעות**: טל מסמנת כחוזרת, אנחנו מסמנים כמקורית
- **~50 הצעות**: אנחנו מסמנים כחוזרת, טל מסמנת כמקורית

**פירוש**: טל כנראה משתמשת בשיטה סמנטית רחבה יותר מעבר לחיפוש ביטויים מפורשים — כנראה דמיון תוכני או השוואת נוסחים. **הרגרסיה שלנו מוצאת רק ~40% מחזרות שטל מוצאת.** מצד שני, כאשר אנחנו כן אומרים "חוזרת", טל כמעט תמיד מסכימה — כלומר דיוק גבוה, רק recall נמוך.

המשמעות: המספר האמיתי של חזרות נמצא כנראה **בין** 8.8% (שלנו) ו-58% (טל). ההצעות שאנחנו מוצאים הן חזרות "מוצהרות" (הצעה חוזרת מכירה בקודמת בדברי ההסבר); ההצעות שרק טל מוצאת הן חזרות "משתמעות" (תוכן דומה ללא הצהרה).
