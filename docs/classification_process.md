...
| מקוריות אפקטיביות אחרי פוסט-עיבוד | 31,444 |
| חוזרות אפקטיביות אחרי פוסט-עיבוד | 20,229 |
| הצעות חוזרות שקודמו למקוריות אפקטיביות | 1,058 |
...
קובץ הפלט: `data/snapshots/All_Private_Bills_K1_K25_classified.xlsx` — 51,673 שורות × 31 עמודות.
...
| `recurrence_type` | **שתי רמות של חזרה**: `identical` = הצעה שהוצהרה מפורשות כ"הצעת חוק זהה"; `similar` = הצעה שהוצהרה כ"הצעת חוק דומה" או "בהמשך להצעת חוק". ריק להצעות שלא זוהה בהן ביטוי חזרה. |
...
בדיקות השלמות האחרונות לקובץ שנשלח (`2026-04-24 15:29 +0300`) עברו:
...
- [x] 0 שורות חוזרות (`is_recurring_upstream=True`) עם `recurrence_type` ריק.
