...
class QueryExecutor:
    ...
    def update_session_state_with_results(
        self, query_name: str, results_df: pd.DataFrame, executed_sql: str, applied_filters_info: List[str]
    ) -> None:
        """
    ...
    def update_session_state_with_table_results(self, table_name: str, results_df: pd.DataFrame) -> None:
        """
