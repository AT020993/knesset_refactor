...
def get_available_plots():
    ...
    return {
        ...
        "Agenda Analytics": {
            "Agendas Over Time": plot_agendas_by_time_period,
        ...
        "Bills Analytics": {
            "Bills Over Time": plot_bills_by_time_period,
            "Bill Categories": plot_bill_subtype_distribution,
            "Bills per Faction": plot_bills_per_faction,
            "Bills by Coalition Status": plot_bills_by_coalition_status,
            "Top Bill Sponsors": plot_top_bill_initiators,
            "Legislator Collaboration Network": plot_mk_collaboration_network,
