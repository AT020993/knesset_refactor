...
class KnessetTables:
    ...
    FACTION = TableMetadata(
        name="KNS_Faction", description="Political factions in the Knesset", primary_key="FactionID"
    )
    ...
    GOV_MINISTRY = TableMetadata(
        name="KNS_GovMinistry", description="Government ministries", primary_key="GovMinistryID"
    )

    STATUS = TableMetadata(name="KNS_Status", description="Status codes and descriptions", primary_key="StatusID")
    ...
    COMMITTEE = TableMetadata(name="KNS_Committee", description="Knesset committees", primary_key="CommitteeID")
    ...
    KNESSET_DATES = TableMetadata(
        name="KNS_KnessetDates", description="Knesset term dates and information", primary_key="KnessetNum"
    )
    ...
    LAW = TableMetadata(name="KNS_Law", description="Enacted laws", primary_key="LawID", dependencies=["KNS_Bill"])

    ISRAEL_LAW = TableMetadata(name="KNS_IsraelLaw", description="General Israeli legislation", primary_key="LawID")
    ...
    def get_all_tables(cls) -> List[TableMetadata]:
        ...
        return [
            cls.PERSON,
            cls.FACTION,
            cls.PERSON_TO_POSITION,
            cls.GOV_MINISTRY,
            cls.STATUS,
            cls.QUERY,
            cls.AGENDA,
            cls.COMMITTEE,
            cls.COMMITTEE_SESSION,
            cls.PLENUM_SESSION,
            cls.KNESSET_DATES,
            cls.BILL,
            cls.BILL_INITIATOR,
